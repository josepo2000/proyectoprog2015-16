...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    public VistaPrincipal() {
        initComponents();
        try {
            categorias=proyectofc1.Conexion.listadocategorias();
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Ver todas las categorias");
        ...
        jButton4.setText("Borrar o editar categoria");
        ...
        jButton5.setText("Elegir categoria");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       VistaElegirCategoria ventana = new VistaElegirCategoria();
